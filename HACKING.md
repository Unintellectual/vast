...
hidden if the `vast_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `vast_DEVELOPER_MODE` to the configure
...
Runs the executable target `vast_exe`.
